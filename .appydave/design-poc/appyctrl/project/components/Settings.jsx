    ...
    },
    {
      ...
      icon: (
        <Icon size={13} sw={1.7}>
          ...
          <path d="M6 8.5v7M8.5 18a6 6 0 0 0 7-3.5" />
        </Icon>
      ),
    },
    {
      ...
      icon: (
        <Icon size={13} sw={1.7}>
          <path d="M9 7l-3 3 3 3M15 7l3 3-3 3M11 17l2-10" />
        </Icon>
      ),
    },
    {
              ...
              <button
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.background =
                    tab === t.id ? "var(--ac-row-active)" : "var(--ac-row-hover)")
                }
                onMouseLeave={(e) =>
                  (e.currentTarget.style.background =
                    tab === t.id ? "var(--ac-row-active)" : "transparent")
                }
                style={{
                  display: "flex",
                  alignItems: "center",
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          {version && (
            <span style={{ color: "var(--ac-fg-3)", fontFamily: "var(--font-mono)", fontSize: 11 }}>
              {version}
            </span>
          )}
          {status && (
  ...
  return (
    <>
      ...
      <Card>
        <Row
          title="Theme"
          sub="Choose how AppyCtrl looks across the app."
          control={<FauxSelect label="System" />}
        />
        <Row
          title="Time format"
          sub="System default: follows your browser or OS clock preferences."
          control={<FauxSelect label="System default" />}
        />
        <Row
          title="Diff line wrapping"
          sub="Set the default wrap state when the diff panel opens."
          control={<Switch on={diffWrap} onChange={setDiffWrap} />}
        />
        <Row
          title="Assistant output"
          sub="Show token-by-token output while a response is in progress."
          control={<Switch on={tokens} onChange={setTokens} />}
        />
        <Row
          title="Auto-open task panel"
          sub="Open the right-side plan and task panel automatically when steps appear."
          control={<Switch on={autoOpen} onChange={setAutoOpen} />}
        />
        <Row
          title="New threads"
          sub="Pick the default workspace mode for newly created draft threads."
          control={<FauxSelect label="Local" />}
        />
        <Row
          title="Add project starts in"
          sub="Leave empty to use ‘~/’ when the Add Project browser opens."
          control={
            <input
              placeholder="~/"
              style={{
        ...
        <Row
          ...
          sub="Require a second click on the inline archive action before a thread is archived."
          control={<Switch on={archiveConfirm} onChange={setArchiveConfirm} />}
        />
        <Row
          title="Delete confirmation"
          sub="Ask before deleting a thread and its chat history."
          control={<Switch on={deleteConfirm} onChange={setDeleteConfirm} />}
        />
        <Row
          title="Text generation model"
          sub="Configure the model used for generated commit messages, PR titles, and similar Git text."
          separator={false}
          control={
...
function SettingsSource() {
  return (
    <>
      <GroupLabel
        action={
          <button className="ac-icon-btn" style={{ width: 22, height: 22 }}>
            <Icon size={11} sw={1.8}>
              <path d="M21 12a9 9 0 1 1-3-6.7L21 8" />
              <path d="M21 3v5h-5" />
            </Icon>
      ...
      <Card>
        <ProviderRow
          icon={
            <Icon size={18} fill="currentColor" stroke="none" style={{ color: "#f0532f" }}>
              <circle cx="12" cy="12" r="10" />
              <path d="M12 5v14M5 12h14" stroke="#fff" strokeWidth="2" fill="none" />
            </Icon>
          }
          name="Git"
      ...
      <Card>
        <ProviderRow
          ...
          name="GitHub"
          version="gh version 2.91.0 (2026-04-22)"
          sub="Authenticated as **********"
          on={true}
        />
        <div style={{ borderTop: "1px solid var(--ac-sidebar-border)" }} />
        <ProviderRow
          icon={
            <Icon size={18} fill="currentColor" stroke="none" style={{ color: "#fc6d26" }}>
              <path d="M12 22l-9-13 3-9 6 8 6-8 3 9z" />
            </Icon>
          }
          name="GitLab"
        ...
        <ProviderRow
          icon={
            <Icon size={18} sw={1.6}>
              <path d="M3 12l4-9 5 9-5 9zM21 12l-4-9-5 9 5 9z" />
            </Icon>
          }
          name="Azure DevOps"
          status="Coming Soon"
        ...
        <ProviderRow
          icon={
            <Icon size={18} fill="currentColor" stroke="none" style={{ color: "#2684ff" }}>
              <path d="M3 4h18l-2 16H5z" />
            </Icon>
          }
          name="Bitbucket"
          status="Coming Soon"
  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ color: "var(--ac-fg-1)", fontWeight: 600, fontSize: 14 }}>
          No archived threads
        </div>
        <div style={{ marginTop: 4, color: "var(--ac-fg-3)", fontSize: 12.5 }}>
