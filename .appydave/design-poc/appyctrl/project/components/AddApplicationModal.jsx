      ...
      >
        ...
        >
          <div style={{ flex: 1 }}>
            ...
            >
              {isEdit ? "Configure Application" : "Add Application"}
            </div>
            <div style={{ fontSize: 12.5, color: "var(--ac-fg-2)", lineHeight: 1.5 }}>
              Applications appear in the sidebar and take over the right pane when opened. They can
              run locally or point at a cloud endpoint.
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div style={{ padding: "8px 20px 16px" }}>
          ...
          <AppField label={isCloud ? "URL" : "Command"}>
            <input
              ...
              placeholder={isCloud ? "https://app.example.com" : "pnpm --filter angle-eye dev"}
              style={{
                width: "100%",
                height: 32,
                padding: "0 10px",
